...
// HTTP behaviour is covered in catapi_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "catapi://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("catapi", "about")
	if err != nil || got.String() != "catapi://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want catapi://page/about", got.String(), err)
	}
}
