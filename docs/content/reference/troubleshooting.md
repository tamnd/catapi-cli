...
Most of these come down to network reality or how catapi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

catapi rate-limits like any public site. catapi already paces
...
Where a surface is gated, catapi reads a cookie or token you supply
...
`catapi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what catapi actually did
